...
A keylogger that installs itself to Steam/cache and latches onto the windows scheduler in order to start on computer startup. It then, emails keys written every 30 seconds only if there have been keys written. 
